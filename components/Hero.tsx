  ...
  return (
    <header id="comenzar" className="container mx-auto px-6 py-20 md:py-32 flex flex-col lg:flex-row items-center justify-between gap-16 relative z-10">
      <div className="flex-1 space-y-6 text-center lg:text-left">
        <span className="bg-gradient-to-r from-purple-50 to-cyan-50 text-purple-700 text-[10px] font-black tracking-widest uppercase px-4 py-1.5 rounded-full inline-block border border-purple-200/60 shadow-sm backdrop-blur-sm">
          ⚡ Infraestructura de comercio unificado
        </span>
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter text-slate-950 leading-[1.05]">
          Escala tu negocio <br />
          <span className="bg-gradient-to-r from-purple-600 via-indigo-600 to-cyan-500 bg-clip-text text-transparent drop-shadow-sm">sin fronteras</span>
        </h1>
        <p className="text-lg md:text-xl text-slate-600 max-w-xl leading-relaxed font-normal">
          El ecosistema de marketplace diseñado para economías dinámicas. Gestiona stock, sincroniza divisas en tiempo real y recibe pagos globales en <span className="text-slate-900 font-semibold">iPhone, Android o PC</span>.
        </p>
        <div className="flex flex-wrap gap-4 justify-center lg:justify-start pt-6">
          <Link href="#comenzar" className="bg-slate-950 text-white font-bold px-10 py-4 rounded-xl shadow-xl hover:bg-slate-900 transition-all text-center">Probar Gratis</Link>
          <Link href="#funciones" className="bg-white/60 backdrop-blur-sm hover:bg-slate-100/80 text-slate-700 border border-slate-200 font-semibold px-10 py-4 rounded-xl shadow-sm transition-all text-center">Explorar Soluciones</Link>
        </div>
      </div>

        {/* 🎭 ESCENA MULTIPLATAFORMA - INTERACTIVIDAD TOTAL */}
          ...
          <div className="relative w-full min-h-[450px] flex items-center justify-between p-2 gap-4">
            ...
            <div className="w-[28%] aspect-[9/19] bg-white/80 backdrop-blur-2xl rounded-[2rem] shadow-xl border-[8px] border-slate-950 overflow-hidden flex flex-col items-center justify-center p-4 text-center ring-1 ring-black/10 self-end mb-6 cursor-pointer z-20
              ...
              <div className="relative w-10 h-10 overflow-hidden rounded-xl border border-slate-200 shadow-sm mb-3 bg-gradient-to-br from-purple-600 to-cyan-500 p-[1px]">
                ...
                <div className="relative w-full h-full rounded-[9px] overflow-hidden bg-white">
                  ...
                  <Image src="/logo.png" alt="Logo iOS" fill sizes="50px" className="object-cover" />

                </div>

              </div>

              <p className="text-slate-900 font-black text-xs tracking-wide uppercase">iOS Client</p>

              <p className="text-slate-500 text-[9px] mt-1 font-normal leading-tight">Interfaz universal de cara al consumidor.</p>
            ...
            <div className="absolute left-[15%] right-[15%] top-0 bottom-8 bg-white/60 backdrop-blur-xl rounded-2xl overflow-hidden flex flex-col ring-1 ring-black/10 z-10 transition-all duration-500 ease-out transform shadow-2xl border-4 border-slate-900
              ...
              <div className="h-8 bg-slate-900 border-b border-slate-800 flex items-center gap-2 px-4 justify-between transition-colors duration-500 group-hover/scene:bg-slate-950">
                ...
                <p className="text-slate-400 text-[9px] font-mono tracking-tight group-hover/scene:text-purple-400 lowercase">comprapp.global/dashboard</p>
              ...
              <div className="w-full flex-1 bg-white/10 p-6 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-slate-900 font-extrabold text-sm tracking-wide uppercase">Consola Web Enterprise</p>

                <p className="text-slate-500 text-[10px] px-8 max-w-[280px] mt-1 font-normal leading-tight">Panel avanzado de analítica, cadena de suministro y gestión multi-sede.</p>
            ...
            <div className="w-[32%] aspect-[3/4] bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border-[6px] border-slate-900 overflow-hidden flex flex-col items-center justify-center p-4 text-center ring-1 ring-black/10 self-end mb-2 cursor-pointer z-20
              ...
              <div className="relative w-9 h-9 overflow-hidden rounded-xl border border-slate-200 shadow-sm mb-2 bg-gradient-to-br from-purple-600 to-cyan-500 p-[1px]">
                ...
                <div className="relative w-full h-full rounded-[8px] overflow-hidden bg-white">
                  ...
                  <Image src="/logo.png" alt="Logo Android" fill sizes="40px" className="object-cover" />

                </div>

              </div>

              <p className="text-slate-900 font-bold text-xs uppercase">Android POS</p>

              <p className="text-slate-500 text-[9px] mt-1 max-w-[120px] font-normal leading-tight">Aplicación de punto de venta (POS) para operarios y comercios físicos.</p>
