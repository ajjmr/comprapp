  ...
  return (
    <nav className="bg-white/70 backdrop-blur-md border-b border-slate-200/50 sticky top-0 z-50 shadow-sm shadow-slate-100/50">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        <Link href="#inicio" className="flex items-center gap-3 group cursor-pointer">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="#comenzar" className="bg-slate-950 hover:bg-slate-800 text-white text-xs font-bold px-6 py-2.5 rounded-full transition-all shadow-lg border border-white/10 hover:scale-105 transform duration-200">Comenzar Gratis</Link>
        </div>
      </div>
    </nav>
  );
