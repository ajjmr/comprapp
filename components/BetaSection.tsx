  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-lg">
        ...
        {/* Estado de Éxito: Checklist + Canal */}
        {status === "success" ? (
          <motion.div
          ...
          >
            ...
            <div className="bg-[#1A1A2E]/90 backdrop-blur-sm rounded-2xl p-6 mb-8 text-left border border-purple-500/30 shadow-inner">
              ...
              <ul className="space-y-5">
                ...
                >
                  ...
                  <span className="text-white text-sm font-semibold">2. Unirte al Canal Beta (Recibirás la app allí).</span>
                </motion.li>
                <motion.li 
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              href="https://whatsapp.com/channel/0029VbCZztn4IBh7UJ5Ghu26"
              target="_blank"
